...
class DCGAN(object):
    def __init__(self, sess, image_size=513, is_crop=False,
                 batch_size=64, sample_size = 64, output_size=513,
	...
	def load_data(self):
        ...
        step = 2
        width = 513
        X =  np.concatenate([np.expand_dims(loaded[i:i+width], axis=0) for i in range(0, loaded.shape[0]- width , 2)])
        return X  
